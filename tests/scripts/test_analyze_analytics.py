...
class _FakeAggregator:
    ...
    def summary(self, repository_root=None, include_global=False, session_id=None):
    ...
    def tool_usage(self, repository_root=None, include_global=False, session_id=None):
        return (
            ToolUsageStats(
                tool_name="get_minimum_verified_change_set_by_path",
                total_calls=1,
    ...
    def inefficient_calls(self, repository_root=None, include_global=False, session_id=None):
        return (
            InefficiencyFinding(
                kind="unused_tool",
