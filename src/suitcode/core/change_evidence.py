...
class ChangeEvidenceAssembler:
    ...
    def assemble(
        ...
        *,
        ...
        dependency_files: tuple[FileRelationshipRef, ...] = tuple(),
        dependent_files: tuple[FileRelationshipRef, ...] = tuple(),
        render_children: tuple[RenderEdgeRef, ...] = tuple(),
        render_parents: tuple[RenderEdgeRef, ...] = tuple(),
        invariant_findings: tuple[InvariantFindingRef, ...] = tuple(),
        local_flow_edges: tuple[StaticFlowEdgeRef, ...] = tuple(),
        implementation_locations: tuple[CodeLocation, ...] = tuple(),
        implementation_components: tuple[Component, ...] = tuple(),
        dependent_components: tuple[Component, ...] = tuple(),
        dependent_edges: tuple[ComponentDependencyEdge, ...] = tuple(),
        related_tests: tuple[TestImpact, ...] = tuple(),
        related_runners: tuple[RunnerImpact, ...] = tuple(),
        quality_gates: tuple[QualityGateInfo, ...] = tuple(),
    ) -> ChangeEvidencePreview:
